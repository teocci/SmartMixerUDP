...
import com.teocci.smartmixerudp.ContactManager;
...
import com.teocci.smartmixerudp.utils.Networking;

public class MainActivity extends Activity implements ContactUpdateReceiver
{
    static final String TAG = LogHelper.makeLogTag(MainActivity.class);
    ...
    public final static String EXTRA_CONTACT = "com.teocci.smartmixerudp.CONTACT";
    public final static String EXTRA_IP = "com.teocci.smartmixerudp.IP";
    public final static String EXTRA_DISPLAY_NAME = "com.teocci.smartmixerudp.DISPLAYNAME";
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        btnStart.setOnClickListener(new OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                ...
                deviceName = displayNameText.getText().toString();
...
//                updateButton.setVisibility(View.VISIBLE);
                ...
                contactManager = new ContactManager(deviceName, Networking.getIPAddress(true), Networking.getBroadcastIp());
                contactManager.setContactUpdateReceiver(context);
                startCallListener();
            }
        });
        ...
        btnCall.setOnClickListener(new OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                ...
                intent.putExtra(EXTRA_DISPLAY_NAME, deviceName);
        ...
        Thread listener = new Thread(new Runnable()
        {
            ...
            public void run()
            {
                try {
                    ...
                    Log.i(TAG, "[startCallListener]Incoming call listener started");
                    ...
                    while (LISTEN) {
                        ...
                        try {
                            Log.i(TAG, "[startCallListener]Listening for incoming calls");
                            socket.receive(packet);
                            String data = new String(buffer, 0, packet.getLength());
                            Log.i(TAG, "[startCallListener]Packet received from " + packet.getAddress() + " with contents: " + data);
                            ...
                            if (action.equals("CAL:")) {
                                ...
                                Log.w(TAG, "[startCallListener]" + packet.getAddress() + " sent invalid message: " + data);
                            }
                        } catch (SocketTimeoutException ste) {
                            Log.i(TAG, "[startCallListener]SocketTimeoutException: " + ste.toString());
                        } catch (Exception e) {
                            Log.e(TAG, "[startCallListener]Exception: " + e.toString());
                        }
                    }
                    Log.i(TAG, "[startCallListener]Call Listener ending");
                    socket.disconnect();
                    socket.close();
                } catch (SocketException e) {
                    Log.e(TAG, "[startCallListener]SocketException in listener " + e);
                }
            }
        });
        listener.start();
    ...
    public void onStop()
    {
        ...
        if (contactManager != null) {
            contactManager.removeContactUpdateReceiver();
        }
        if (!IN_CALL) {
            finish();
        }
